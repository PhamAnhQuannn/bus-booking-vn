...
A feature request implemented from a Slack message becomes seven different features in seven different heads. A PRD as a written artifact is the single source of truth the team can disagree with productively.
