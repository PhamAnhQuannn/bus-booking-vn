...
|------|--------|-------|--------|
| `landing-golden-1280.jpg` | 768×1397 (portrait) | 216 KB | mobile `<768`, DPR1 + fallback |
| `landing-golden-1280@2x.webp` | 1536×2794 | 277 KB | mobile DPR2 **and** DPR3 (covers 752@2× = 1504 and 430@3× = 1245) |
| `landing-golden-md-1536.jpg` | 1536×1275 | 398 KB | md `768–1023`, DPR1 + fallback |
| `landing-golden-md-1536@2x.webp` | 2048×1700 | 326 KB | md DPR2 (covers 1008@2× = 2016) |
| `landing-golden-1920.jpg` | 1920×1081 | 444 KB | lg `1024–1919`, DPR1 + fallback |
| `landing-golden-1920@2x.webp` | 3072×1729 | 490 KB | lg DPR2; 1.24× residual at the very top of the range |
| `landing-golden-3840.jpg` | 2560×978 | 469 KB | 3xl `≥1920`, DPR1 + fallback |
| `landing-golden-3840@2x.webp` | 3840×1468 | 408 KB | 3xl DPR2 (covers 1905@2× = 3810, i.e. 4K at 200% scaling) |
| `contract-rental-thumb.jpg` | 576×256 | 42 KB | `components/home/ContractCarRental.tsx` — NOT a hero variant |
