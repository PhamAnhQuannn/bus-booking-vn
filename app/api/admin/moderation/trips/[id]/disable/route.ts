/**
 * POST /api/admin/moderation/trips/[id]/disable (Issue 069, Part E).
 *
 * Admin-disables a trip (Trip.moderatedAt = now). SUPER_ADMIN + SUPPORT, TOTP
...
import { setTripModeration } from '@/lib/admin';
import {
  idFromUrl,
  readReason,
  moderationRoute,
