  ...
  return (
    <section className="mx-auto w-full max-w-7xl px-4 py-12">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        {FEATURES.map(({ icon: Icon, slug, title, tagline, details }) => (
          <article
            key={title}
            className="flex flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-e1 transition-all hover:shadow-e2 motion-safe:hover:-translate-y-0.5"
          >
