...
export function OperatorTrustPanel({
  ...
  return (
    <aside aria-label="Thông tin nhà xe và hỗ trợ">
      ...
      <div className="flex flex-col gap-4 rounded-xl border border-border bg-card p-4 shadow-e1 md:sticky md:top-20 lg:top-[104px]">
        <div className="flex flex-col gap-2">
          <span className="inline-flex w-fit items-center gap-1 rounded-full bg-primary/10 px-2.5 py-1 text-xs font-medium text-primary">
            <ShieldCheck className="size-3.5" aria-hidden="true" /> Nhà xe đã được duyệt
          </span>
        ...
        <div className="border-t border-border/60 pt-3">
          <h2 className="mb-2 text-sm font-semibold text-foreground">Đặt vé an tâm</h2>
          <ul className="flex flex-col gap-2 text-sm text-muted-foreground">
            <li className="flex items-start gap-2">
              <ShieldCheck className="mt-0.5 size-4 shrink-0 text-primary" aria-hidden="true" />
              Nhà xe được duyệt trước khi mở bán vé
            </li>
            <li className="flex items-start gap-2">
