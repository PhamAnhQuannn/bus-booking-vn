...
export const CONSENT_TEXT = {
  noRefund:
    'Tôi đã đọc và đồng ý với Chính sách hủy vé và hoàn tiền. Tôi hiểu rằng vé đã thanh toán không được hủy hoặc hoàn tiền theo yêu cầu, trừ trường hợp nhà xe hủy chuyến.',
  piiStorage:
