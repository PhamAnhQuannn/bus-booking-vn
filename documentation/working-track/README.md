...
| # | File | Severity | Status | Comparison | Spec |
|---|------|----------|--------|------------|------|
| 04 | [payout-account-encryption](04-payout-account-encryption.md) | HIGH | NOT_STARTED | 02 S2 | KG-03, HD-001 |
| 05 | [admin-totp-replay-protection](05-admin-totp-replay-protection.md) | HIGH | NOT_STARTED | 02 S3 | HD-012 |
...
| 20 | [zod-boot-validation-completeness](20-zod-boot-validation-completeness.md) | MEDIUM | NOT_STARTED | 02 S8 | SI-006 |
| 21 | [pnpm-audit-ci-stage](21-pnpm-audit-ci-stage.md) | HIGH | NOT_STARTED | 02 S6, 05 | KG-01 |
